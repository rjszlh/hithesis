...
\begin{figure}[h]
  \centering
  \includegraphics[width=1\textwidth]{figures/chapter03/HAGVNet结构图.png}
  \caption{HAGVNet结构图}
  \label{HAGVNet结构图}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=1\textwidth]{figures/chapter03/不同代价卷积块对比.png}
  \caption{不同代价卷积块对比}
  \label{不同代价卷积块对比}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics{figures/chapter03/代价聚合结构图.png}
  \caption{代价聚合结构图}
  \label{代价聚合结构图}
\end{figure}
