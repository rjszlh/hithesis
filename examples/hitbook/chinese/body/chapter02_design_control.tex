...
\begin{table}[htbp]
  \centering
  \bicaption[两轮平衡车设计指标]{}{两轮平衡车设计指标}{Table$\!$}{两轮平衡车设计指标}
  \vspace{0.5em}\wuhao
  \begin{tabular}{>{\centering\arraybackslash}p{0.333\textwidth}>{\centering\arraybackslash}p{0.333\textwidth}>{\centering\arraybackslash}p{0.333\textwidth}}
    \toprule
    指标分类 & 指标项目 & 具体要求 \\
    \midrule
    \multirow{3}{*}{尺寸} & 总长 & ≤900mm \\
     & 总宽 & ≤750mm \\
     & 整车质量 & 70kg \\
    \multirow{4}{*}{运动性能} & 额定载荷 & 75kg \\
     & 最大运动速度 & 15km/h \\
     & 最大加速度 & 2m/s2 \\
     & 爬坡性能 & 15° \\
    \bottomrule
...
\begin{table}[htbp]
  \centering
  \bicaption[进动电机技术参数]{}{进动电机技术参数}{Table$\!$}{进动电机技术参数}
  \vspace{0.5em}\wuhao
...
\begin{table}[htbp]
  \centering
  \bicaption[各种路面滚动摩擦系数]{}{各种路面滚动摩擦系数}{Table$\!$}{各种路面滚动摩擦系数}
  \vspace{0.5em}\wuhao
...
\begin{table}[htbp]
  \centering
  \bicaption[轮毂电机WYQ-17技术参数]{}{轮毂电机WYQ-17技术参数}{Table$\!$}{轮毂电机WYQ-17技术参数}
  \vspace{0.5em}\wuhao
...
\begin{table}[htbp]
  \centering
  \bicaption[控制系统软件任务分析]{}{控制系统软件任务分析}{Table$\!$}{控制系统软件任务分析}
  \vspace{0.5em}\wuhao
  \begin{tabular}{>{\centering\arraybackslash}p{0.2\textwidth}>{\centering\arraybackslash}p{0.2\textwidth}>{\centering\arraybackslash}p{0.2\textwidth}>{\centering\arraybackslash}p{0.2\textwidth}>{\centering\arraybackslash}p{0.2\textwidth}}
    \toprule
    编号 & 任务 & 实时性 & 驱动方式 & 运行周期 \\
    \midrule
    1 & 设备通信 & 高 & 中断 & 无 \\
...
\begin{table}[htbp]
  \centering
  \bicaption[电机控制模式设置]{}{电机控制模式设置}{Table$\!$}{电机控制模式设置}
  \vspace{0.5em}\wuhao
...
\begin{table}[htbp]
  \centering
  \bicaption[状态反馈报文内容]{}{状态反馈报文内容}{Table$\!$}{状态反馈报文内容}
  \vspace{0.5em}\wuhao
  \begin{tabular}{>{\centering\arraybackslash}p{0.167\textwidth}>{\centering\arraybackslash}p{0.167\textwidth}>{\centering\arraybackslash}p{0.167\textwidth}>{\centering\arraybackslash}p{0.167\textwidth}>{\centering\arraybackslash}p{0.167\textwidth}>{\centering\arraybackslash}p{0.167\textwidth}}
    \toprule
